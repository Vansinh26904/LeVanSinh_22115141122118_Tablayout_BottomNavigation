 ...
 * Use the {@link HometownFragment#newInstance} factory method to
...
public class HometownFragment extends Fragment {
    ...
    public static HometownFragment newInstance(String param1, String param2) {
        HometownFragment fragment = new HometownFragment();
